...
/* A PriorityQueue example where we are adding books to queue and printing all the books. 
 * The elements in PriorityQueue must be of Comparable type. 
 * String and Wrapper classes are Comparable by default. 
 * To add user-defined objects, you need to implement Comparable interface. */
